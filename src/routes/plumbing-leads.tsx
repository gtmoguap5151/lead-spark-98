...
function PlumbingLeadsPage() {
  ...
  return <div className="min-h-screen bg-background"><SiteHeader /><main>
    ...
    <section className="mx-auto max-w-4xl px-4 py-14 text-center sm:py-16"><h2 className="text-3xl font-bold sm:text-4xl">Ready to add Rivet Reach to your plumbing sales pipeline?</h2><Button asChild size="lg" className="mt-7 h-14 px-8 text-lg font-bold"><Link to="/login" search={{ mode: "signup" }}>Create Contractor Account</Link></Button></section>
  </main><SiteFooter /></div>;
}
