...
function FindPlumberPage() {
  return <div className="min-h-screen bg-background"><SiteHeader /><main>
    ...
    <section className="mx-auto max-w-4xl px-4 py-14 text-center sm:py-16"><h2 className="text-3xl font-bold sm:text-4xl">Ready to request plumbing help?</h2><Button asChild size="lg" className="mt-7 h-14 px-8 text-lg font-bold"><Link to="/estimate" search={{ service: "Plumbing" }}>Start My Request</Link></Button><p className="mt-5 text-sm text-muted-foreground">Are you a plumbing contractor? <Link to="/plumbing-leads" className="font-semibold text-primary hover:underline">See plumbing lead opportunities.</Link></p></section>
  </main><SiteFooter /></div>;
}
