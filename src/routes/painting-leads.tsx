...
function PaintingLeadsPage() {
  return <div className="min-h-screen bg-background"><SiteHeader/><main>
    ...
    <section className="mx-auto max-w-4xl px-4 pb-14 text-center"><p className="text-lg text-muted-foreground">New contractor accounts can receive one real lead free one time. Continued access requires a paid Rivet Reach plan.</p><Button asChild size="lg" className="mt-6"><Link to="/login" search={{ mode: "signup" }}>Create Contractor Account</Link></Button></section>
  </main><SiteFooter/></div>;
}
