      ...
      <main>
        <section className="bg-steel text-steel-foreground">
          <div className="mx-auto max-w-6xl px-4 py-14 sm:py-20">
            ...
            <Button asChild size="lg" className="mt-8 h-14 px-7 text-lg font-bold"><Link to="/login" search={{ mode: "signup" }}>Create Contractor Account</Link></Button>
          </div>
        </section>
        <section className="mx-auto max-w-6xl px-4 py-14 sm:py-16">
          ...
          <div className="mt-12 text-center"><h2 className="text-3xl font-bold">Your first real lead can be free once.</h2><p className="mx-auto mt-3 max-w-2xl text-lg text-muted-foreground">After the one-time introductory lead, continued access requires payment, credits, or an active paid plan.</p><Button asChild size="lg" className="mt-6"><Link to="/login" search={{ mode: "signup" }}>Get Started</Link></Button></div>
        </section>
      </main>
      <SiteFooter />
    </div>
