    ...
    <section className="relative isolate min-h-[720px] overflow-hidden bg-[#021b16] text-white sm:min-h-[780px]">
      ...
      <div className="relative mx-auto flex min-h-[720px] max-w-6xl items-end px-4 pb-12 pt-20 sm:min-h-[780px] sm:items-center sm:py-24">
        <div className="max-w-2xl rounded-[2rem] border border-emerald-300/20 bg-black/40 p-6 shadow-2xl shadow-emerald-950/40 backdrop-blur-md sm:p-9">
          ...
          <p className="mt-5 max-w-xl text-lg leading-relaxed text-white/85 sm:text-xl">Connect homeowners with trusted contractors and turn real projects into stronger businesses and communities.</p>
          <div className="mt-7 grid gap-3 sm:grid-cols-2">
            <Button asChild size="lg" className="h-16 bg-emerald-500 px-7 text-lg font-black text-[#001812] shadow-lg shadow-emerald-500/20 hover:bg-emerald-400 sm:col-span-2"><a href="#services"><Search className="mr-2 size-5" /> Find a Contractor <ArrowRight className="ml-2 size-5" /></a></Button>
            <Button asChild size="lg" variant="outline" className="h-14 border-emerald-300/35 bg-black/35 px-7 text-lg font-bold text-white hover:bg-emerald-400/15 hover:text-white"><Link to="/estimate">Start My Project</Link></Button>
            <Button asChild size="lg" variant="outline" className="h-14 border-emerald-300/35 bg-black/35 px-7 text-lg font-bold text-white hover:bg-emerald-400/15 hover:text-white"><Link to="/login">I&apos;m a Contractor</Link></Button>
          </div>
